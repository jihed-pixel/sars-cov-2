...
<Container style={{backgroundColor:"rgba(200,200,200,0.75)",backgroundsize: "cover"}} component="main" maxWidth="xs" >
    ...
    <View  >
      ...
      <View style={tailwind(' items-center ')}>
        ...
        <Text style={tailwind('text-gray-700 py-2')}> ?</Text>
      ...
      <View style={styles.row}>
        ...
        <div  >
          ...
          <input  onChange={handleNivEtude} type="radio" value="Non Scolarisé" name="gender1" /> <Text style={tailwind('text-gray-700 py-2')}>Non Scolarisé</Text>
          ...
          <input  onChange={handleNivEtude} type="radio" value="Secondaire" name="gender1" /> <Text style={tailwind('text-gray-700 py-2')}>Secondaire</Text>
